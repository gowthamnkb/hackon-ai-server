...
Remember contact given and use that contact in further queries
...
9. Total Payments or Loads or Recharges in the Last 30 Days
   - If contact has more than 1 accounts of type wallet, get program_id from linked accounts and ask which program to choose
...
- Dont include  in the response
- use from_unixtime() to convert unix timestamps to dates in UTC
"""
