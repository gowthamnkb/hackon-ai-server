...
_default_openai_client: AsyncAzureOpenAI | None = None
...
def set_default_openai_client(client: AsyncAzureOpenAI) -> None:
    global _default_openai_client
    _default_openai_client = client


def get_default_openai_client() -> AsyncAzureOpenAI | None:
